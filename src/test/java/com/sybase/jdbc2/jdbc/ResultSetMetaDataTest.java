 ...
 *
 */
public class ResultSetMetaDataTest extends ResultSetMetaDataTestCase {

    public ResultSetMetaDataTest() throws Exception {
        super(false);
    }
    ...
    public void test_getColumnName() throws Exception {
        ...
        assertEquals("MY_NUMERIC", data.getColumnName(1));
        assertEquals("MY_VARCHAR", data.getColumnName(2));
        assertEquals("MY_DATETIME", data.getColumnName(3));
    }
